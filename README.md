...
若您想获取已经编译好可以直接使用的程序，请点击[Release](https://github.com/clostou/video2gif/releases)下载，并跳过下面环境配置和安装部分的内容，直接阅读[使用说明](https://github.com/clostou/video2gif#%E5%BC%80%E5%A7%8B%E4%BD%BF%E7%94%A8)部分。
